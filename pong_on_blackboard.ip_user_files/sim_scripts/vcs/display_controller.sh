...
#
# Script generated by Vivado on Sun Aug 02 13:42:14 BST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : display_controller.sh
...
#
# Usage        : display_controller.sh
#                display_controller.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                display_controller.sh [-rerun]
#                display_controller.sh [-reset_run]
#                display_controller.sh [-clean]
#                display_controller.sh [-reset_log]
#                display_controller.sh [-help]
#
...
#                script (type 'display_controller.sh -help' for more information).
#
...
# script info
echo -e "display_controller.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./display_controller.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../media/pyra/88d368f5-2c7d-43f4-90cd-458b64c9c5111/Vivado/2025.2/data/rsb/busdef" +incdir+"../../../pong_on_blackboard.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../media/pyra/88d368f5-2c7d-43f4-90cd-458b64c9c5111/Vivado/2025.2/data/rsb/busdef" +incdir+"../../../pong_on_blackboard.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../../../../../media/pyra/88d368f5-2c7d-43f4-90cd-458b64c9c5111/Vivado/2025.2/data/rsb/busdef" +incdir+"../../../pong_on_blackboard.gen/sources_1/ip/clk_wiz_0" \
  "../../../../../Personal\\ Projects/pong-on-blackboard/pong_on_blackboard.srcs/sources_1/imports/new/bin_counter.sv" \
  "../../../../../Personal\\ Projects/pong-on-blackboard/pong_on_blackboard.srcs/sources_1/imports/new/dual_counter.sv" \
  "../../../../../Personal\\ Projects/pong-on-blackboard/pong_on_blackboard.srcs/sources_1/imports/new/vga_controller.sv" \
  "../../../../../Personal\\ Projects/pong-on-blackboard/pong_on_blackboard.srcs/sources_1/imports/new/display_controller.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.display_controller xil_defaultlib.glbl -o display_controller_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./display_controller_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key display_controller_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc display_controller_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./display_controller.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: display_controller.sh [-help]\n\
Usage: display_controller.sh [-step]\n\
Usage: display_controller.sh [-lib_map_path]\n\
Usage: display_controller.sh [-rerun]\n\
Usage: display_controller.sh [-reset_run]\n\
Usage: display_controller.sh [-clean]\n\
Usage: display_controller.sh [-reset_log]\n\
Usage: display_controller.sh [-keep_index]\n\
Usage: display_controller.sh [-noclean_files]\n\n\
